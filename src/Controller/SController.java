...
public class SController extends Table {
    ...
    public void deleteSc(JPanel p, JTable ScheduleTable) {
        int result = JOptionPane.showConfirmDialog(p, "Hapus Jadwal?", "Jadwal Konseling", JOptionPane.OK_CANCEL_OPTION, JOptionPane.QUESTION_MESSAGE);
        ...
        if (result == JOptionPane.OK_OPTION) {
            if (selectedRowIndex != -1) {
                ...
                if (deleteSchedule(number)) {
                    JOptionPane.showMessageDialog(p, "Jadwal berhasil dihapus!!", "Jadwal Konseling", JOptionPane.INFORMATION_MESSAGE);
                } else {
                    JOptionPane.showMessageDialog(p, "Gagal menghapus jadwal!", "Error", JOptionPane.ERROR_MESSAGE);
                }

            } else {
                JOptionPane.showMessageDialog(p, "Tidak ada baris yang dipilih!", "Error", JOptionPane.ERROR_MESSAGE);
            }
