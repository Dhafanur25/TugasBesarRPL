...
public class Link2 extends JButton {

    public Link2() {
        // Use HTML to set the text and style the "Register" part in blue
        String buttonText = "<html><font color='white'>Sudah punya akun? <font color='white'>Login</font></font></html>";
        setText(buttonText);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                setText("<html><font color='white'>Sudah punya akun? <font color='#3dabf5'>Login</font></font></html>");
            }

            @Override
            public void mouseExited(MouseEvent e) {
                // Change the "Register" text color back to blue when the mouse leaves the button
                setText("<html><font color='white'>Sudah punya akun? <font color='white'>Login</font></font></html>");
            }
        });
    }
}