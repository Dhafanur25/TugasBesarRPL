...
public class Link3 extends JButton {
    ...
    public Link3() {
        ...
        String buttonText = "<html><font color='purple'>Kembali ke beranda</font></html>";
        setText(buttonText);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                setText("<html><font color='blue'>Kembali ke beranda</font></html>");
            }

            @Override
            public void mouseExited(MouseEvent e) {
                // Change the "Register" text color back to blue when the mouse leaves the button
                setText("<html><font color='purple'>Kembali ke beranda</font></html>");
            }
        });
    }
}