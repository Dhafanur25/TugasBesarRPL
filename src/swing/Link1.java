...
public class Link1 extends JButton {
    ...
    public Link1() {
        ...
        String buttonText = "<html><font color='white'>Tidak punya akun? <font color='white'>Register</font></font></html>";
        setText(buttonText);
        ...
        addMouseListener(new MouseAdapter() {
            ...
            public void mouseEntered(MouseEvent e) {
                ...
                setText("<html><font color='white'>Tidak punya akun? <font color='#3dabf5'>Register</font></font></html>");
            }

            @Override
            public void mouseExited(MouseEvent e) {
                // Change the "Register" text color back to blue when the mouse leaves the button
                setText("<html><font color='white'>Tidak punya akun? <font color='white'>Register</font></font></html>");
            }
        });
    }
}