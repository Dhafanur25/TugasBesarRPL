...
public class ChangeProfileP extends JPanel {
                    ...
                    .addGroup(mainPanel8Layout.createSequentialGroup()
                        ...
                        .addGroup(mainPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, mainPanel8Layout.createSequentialGroup()
                                ...
                                .addGroup(mainPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
    ...
    private void buttonSaveChangesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSaveChangesActionPerformed
        ...
        String emailD = BioUserC.getTitleEmailBU().getText();
        String email = emailD;
        ...
        ResultSet account = database.getDB("user", "Username", emailD);
        try {
            if (account.next()){
                ID = account.getInt("ID");
                passl = account.getString("Password");
                temp = account.getString("Profile_Pic_Path");
                filepathl = (temp != null) ? temp.replace("\\", "/") : defaults;
            }
        ...
        database.updateDB("user", nama, email, uName, pass, phone, address, bio,filePath, ID);
