...
public class ChangeProfileP extends JPanel{
    ...
    private void doCP(){
        String passl = null;
        String filepathl = database.getDefaults();
        ...
        if (!isiPassCP.getText().trim().equals("")){
            if(isiPassCP.getText().trim().length() < 8){//cek if password is less than 8
        ...
        try {
            if (account.next()){
                ...
                filepathl = (temp != null) ? temp : database.getDefaults();
            }
    ...
    private void buttonChangeProfilePhotoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonChangeProfilePhotoActionPerformed
        ...
        if (returnValue == JFileChooser.APPROVE_OPTION) {
            ...
            filePath = (temp != null) ? temp.replace("\\", "/") : database.getDefaults();   
        }
