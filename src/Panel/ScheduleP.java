...
public class ScheduleP extends Table {
    ...
    private void initComponents() {
        ...
        ScheduleTable.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Counselor", "Day", "Time", "Meeting Link(*Right click to copy)"
            }
        ) {
    ...
    private void buttonDeleteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonDeleteActionPerformed
        ...
        QSure x = new QSure();
        x.getLabelSure().setText("Delete Schedule?");
        x.setVisible(true);
        ...
        x.getButtonOk().addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (selectedRowIndex != -1) {
                    // Get data from the model based on the selected row index
                    ...
                    try {
                        ...
                        if (database.DeleteScheduleDB(number)) {
                            y.getLabelSure().setText("Schedule has been deleted!");
                        } else {
                            y.getLabelSure().setText("Failed to delete schedule!");
                        }
                    } catch (NumberFormatException ex) {
                        y.getLabelSure().setText("Invalid schedule number!");
                    }
                } else {
                    y.getLabelSure().setText("No row selected!");
                }
                y.setVisible(true);
    ...
    public void fillTable(){
        ...
        ResultSet account = database.getJadwalDB(); 
        try {
            while(account.next()){
                String num = account.getString("Schedule_ID");
                ...
                String Data[] = {num, kon, hari, jam, ml};
