...
public class ForgotP extends JPanel{
    ...
    private void initComponents() {
        ...
        isiNewPassF = new swing.CoolTextField();
        ...
        isiNewPassF.setBackground(new java.awt.Color(0, 0, 0));
        isiNewPassF.setHint("New Password");
                ...
                .addGroup(mainPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(mainPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(mainPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(isiNewPassF, javax.swing.GroupLayout.PREFERRED_SIZE, 239, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(mainPanel1Layout.createSequentialGroup()
                        .addGap(161, 161, 161)
        ...
        mainPanel1Layout.setVerticalGroup(
            ...
            .addGroup(mainPanel1Layout.createSequentialGroup()
                ...
                .addGap(0, 0, 0)
                .addComponent(isiNewPassF, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(18, 18, 18)
    ...
    private void buttonResetActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonResetActionPerformed
        ...
        String pass = isiNewPassF.getText().trim(); 
        ...
        boolean checker = database.cekDB("user","Email", masukan);
        if(checker){
            ...
            if(database.updatePassDB(ID, pass)){
                isiNewPassF.setText("");
                isiEmailF.setText("");
                x.getLabelSure().setText("Password has been reset succesfully!");
                cardLayout.show(cards, "LoginC");
            }else{
                x.getLabelSure().setText("Password has failed to be reset!");
            }

        }else{
            x.getLabelSure().setText("The account doesn't exist!");
        }
        x.setVisible(true);
    ...
    private swing.CoolTextField isiNewPassF;
