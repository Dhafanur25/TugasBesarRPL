...
public class FeedbackP extends javax.swing.JPanel {
    ...
    private void buttonPrevActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonPrevActionPerformed
        ...
        currentCardIndex = (currentCardIndex - 1 + cardPanel.getComponentCount()) % cardPanel.getComponentCount();
    }//GEN-LAST:event_buttonPrevActionPerformed

    private void buttonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonNextActionPerformed
        CardLayout cardLayout = (CardLayout) cardPanel.getLayout();
        cardLayout.next(cardPanel);
        currentCardIndex = (currentCardIndex + 1) % cardPanel.getComponentCount();
    ...
    private void doFB(){
        if (insertFBDB(isiFB.getText())){
            ...
            JOptionPane.showMessageDialog(this, "Failed to post feedback!", "Error", JOptionPane.ERROR_MESSAGE);
        }
