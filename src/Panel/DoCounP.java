...
public class DoCounP extends javax.swing.JPanel {
    ...
    private void buttonSetSActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSetSActionPerformed
        ...
        if (!isiK.equals("<Choose Counselor>")      &&
            ...
            QSure x = new QSure();
            x.getLabelSure().setText("Set Schedule?");
            x.setVisible(true);
            ...
            y.getLabelSure().setText("Choose Counselor");
            y.setVisible(true);
        }else if (isiH.equals("<Choose Counseling Day>")){
            y.getLabelSure().setText("Choose Counseling Day");
            y.setVisible(true);
        }else if (isiJ.equals("<Choose Counseling Time>") ){
            y.getLabelSure().setText("Choose Counseling Time");
            y.setVisible(true);
        }
    ...
    public void doSetSchedule(){
        ...
        if (database.insertJadDB(IDKon, IDHari, IDJam)){
            x.getLabelSure().setText("Schedule successfully addded!");
        }else{
            x.getLabelSure().setText("Schedule is taken, Failed to add schedule!");
        }
        reset();
