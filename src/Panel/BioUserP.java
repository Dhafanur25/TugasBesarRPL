...
public class BioUserP extends javax.swing.JPanel {
    ...
    /**
     * Creates new form BioUserP
     */
    private JPanel cards;
    private CardLayout cardLayout;
    private Database database = Database.getInstance();
    
    public BioUserP(JPanel cards, CardLayout cardLayout){
        this.cards = cards;
    ...
    private void buttonLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonLogOutActionPerformed
        // TODO add your handling code here:
        QSureLO x = new QSureLO(cards, (CardLayout) cards.getLayout());
        x.setVisible(true);
    ...
    private void buttonScheduleActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonScheduleActionPerformed
        // TODO add your handling code here:
        QSchedule x = new QSchedule();
        DefaultTableModel tbModel = (DefaultTableModel) x.getScheduleTable().getModel();
        ...
        try {
            ...
            resizeColumnWidth(x.getScheduleTable());
            addCopyFunctionality(x.getScheduleTable());
            x.setVisible(true);
    ...
    private void addCopyFunctionality(JTable table) {
