    ...
    private void doLoginUser(){
        ...
        try {
            if (account != null && account.next()) {
                ...
                WelcomeC.getProfilePicW().setPic((profilePic != null) ? profilePic : database.getDefaults());

                BioUserC.getProfilePicBU().setPic((profilePic != null) ? profilePic : database.getDefaults());
