...
public class LoginP extends JPanel{
    ...
    public LoginP(JPanel cards, CardLayout cardLayout, BioUserP BioMahC, WelcomeP WelcomeC, FeedbackP FeedbackC){
        ...
        mainPanel1Layout.setVerticalGroup(
            ...
            .addGroup(mainPanel1Layout.createSequentialGroup()
                ...
                .addGroup(mainPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    ...
                    .addComponent(isiPasswordL, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    ...
    private void buttonSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSignInActionPerformed
        ...
        if(checker == 1){
            account = database.getDB("user", "ID", Integer.toString(database.getIDAcc()));
            try {
                if (account != null && account.next()) {
                    ...
                    WelcomeC.getProfilePicW().setPic((profilePic != null) ? profilePic : "C:/Users/dhafa/Downloads/Java Codes/YouthWellness/src/Background/img/imgEmpty.jpg");

                    BioUserC.getProfilePicBU().setPic((profilePic != null) ? profilePic : "C:/Users/dhafa/Downloads/Java Codes/YouthWellness/src/Background/img/imgEmpty.jpg");
            ...
            ResultSet fb = database.getDB("feedback", "id_user", Integer.toString(database.getIDAcc()));
            try {
                int i = 0; 
            ...
            x.getLabelSure().setText("Email/Username is incorrect");
            x.setVisible(true); 
        }else if(checker == 0){
            x.getLabelSure().setText("Password is incorrect");
            x.setVisible(true);
        }
