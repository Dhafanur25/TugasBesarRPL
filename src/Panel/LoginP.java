...
public class LoginP extends JPanel{
    ...
    public LoginP(JPanel cards, CardLayout cardLayout, BioUserP BioMahC, WelcomeP WelcomeC){
    ...
    private void buttonSignInActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_buttonSignInActionPerformed
        ...
        int checker = database.loginDB("user",masukan, passL);
        if(checker == 1){
            if(database.validateEmail(masukan)){
                account = database.getDB("user", "Email", masukan);
            }else{
                account = database.getDB("user", "Username", masukan);
            }
